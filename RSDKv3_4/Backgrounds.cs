...
namespace RSDKv3
{
    public class Backgrounds : RSDKv3_4.Backgrounds
    {
        public new class ScrollInfo : RSDKv3_4.Backgrounds.ScrollInfo
        {
            public ScrollInfo() { }
        ...
        public new class Layer : RSDKv3_4.Backgrounds.Layer
        {
