...
namespace RSDKv3_4
{
    public abstract class Bytecode
    {
        ...
        protected List<ScriptInfo> scripts = new List<ScriptInfo>();
        protected List<FunctionScript> functionList = new List<FunctionScript>();
...
namespace RSDKv3
{
    public class Bytecode : RSDKv3_4.Bytecode
    {
        public new class ScriptInfo : RSDKv3_4.Bytecode.ScriptInfo
        {
            public ScriptInfo() { }
